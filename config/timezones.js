// Comprehensive list of IANA timezones for user selection
module.exports = {
    ...
    popular: [
        ...
        { value: 'Europe/London', label: 'Greenwich Mean Time (UK)', offset: '+00:00/+01:00' },
        { value: 'Europe/Berlin', label: 'Central European Time', offset: '+01:00/+02:00' },
        { value: 'Europe/Stockholm', label: 'Central European Time (Sweden)', offset: '+01:00/+02:00' },
    ...
    // Complete IANA timezone list organized by region
    regions: {
        'Africa': [
    ...
    isValidTimezone: function (timezone) {
        const allTimezones = [
            ...this.popular.map(tz => tz.value),
            ...Object.values(this.regions).flat()
        ];
